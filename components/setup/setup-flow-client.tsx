...
export function SetupFlowClient({ lang, dir }: Props) {
  ...
  const errorMessages: Record<OnboardingErrorCode, string> = {
    ...
    legal_form_required: onboarding("errors.legal_form_required"),
    street_required: onboarding("errors.street_required"),
    street_no_required: onboarding("errors.street_no_required"),
    postcode_required: onboarding("errors.postcode_required"),
    city_required: onboarding("errors.city_required"),
    register_number_required: onboarding("errors.register_number_required"),
    register_court_required: onboarding("errors.register_court_required"),
