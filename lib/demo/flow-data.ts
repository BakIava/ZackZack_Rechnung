...
export const FLOW_CATALOG: KatalogEintrag[] = [
  { id: "c1", de: "Malerarbeiten Wandfläche", uebersetzungen: { de: "Malerarbeiten Wandfläche", tr: "Duvar boyama", ar: "طلاء الجدران" }, einheit: "m²", preisCents: 1200 },
  { id: "c2", de: "Tapete entfernen", uebersetzungen: { de: "Tapete entfernen", tr: "Duvar kağıdı sökme", ar: "إزالة ورق الجدران" }, einheit: "m²", preisCents: 450 },
  { id: "c3", de: "Deckenanstrich", uebersetzungen: { de: "Deckenanstrich", tr: "Tavan boyama", ar: "طلاء السقف" }, einheit: "m²", preisCents: 1000 },
  { id: "c4", de: "Tapezieren", uebersetzungen: { de: "Tapezieren", tr: "Duvar kağıdı kaplama", ar: "تركيب ورق الجدران" }, einheit: "m²", preisCents: 1400 },
  { id: "c5", de: "Fassadenanstrich", uebersetzungen: { de: "Fassadenanstrich", tr: "Cephe boyama", ar: "طلاء الواجهة" }, einheit: "m²", preisCents: 2800 },
  { id: "c6", de: "Lackierarbeiten Türen", uebersetzungen: { de: "Lackierarbeiten Türen", tr: "Kapı lake / boya", ar: "طلاء الأبواب" }, einheit: "Stk.", preisCents: 9500 },
  { id: "c7", de: "Grundierung auftragen", uebersetzungen: { de: "Grundierung auftragen", tr: "Astar sürme", ar: "طبقة أساس" }, einheit: "m²", preisCents: 650 },
  { id: "c8", de: "Spachtelarbeiten", uebersetzungen: { de: "Spachtelarbeiten", tr: "Macunlama", ar: "أعمال المعجون" }, einheit: "m²", preisCents: 800 },
];
